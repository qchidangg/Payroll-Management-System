...
class Payroll:
    def __init__(self, root):
        ...
        notebook.add(self.Tabcontrol2, text='View Payment')
        notebook.add(self.Tabcontrol3, text='Notebook')
        notebook.grid()
...
# ==============================================================================================
        def iExit():
            iExit = tkinter.messagebox.askyesno(
                "Payroll system", "Confirm if you want to exit")
            if iExit > 0:
                root.destroy()
                return
        ...
        def addData():
            if EmployeeName.get() == "" or Address.get() == "" or Reference.get() == "":
                ...
                sqlCon = pymysql.connect(
                    host="localhost", user="root", password="chidang251103", database="payment")
                cur = sqlCon.cursor()
...
# ==============================================================================================
        def DisplayData():
            ...
            result = cur.fetchall()
            if len(result) != 0:
                self.payroll_records.delete(
                    *self.payroll_records.get_children())
                for row in result:
...
#====================================================================================
        ...
        def update():
            sqlCon = pymysql.connect(
                host="localhost", user="root", password="chidang251103", database="payment")
            cur = sqlCon.cursor()
            cur.execute("UPDATE payment SET fullname=%s, address=%s, cityweighting=%s, basicsalary=%s,\
            overtime=%s, grosspay=%s, tax=%s, pension=%s,\
            nipayment=%s, deductions=%s, postcode=%s, gender=%s, \
            payday=%s, taxperiod=%s, taxcode=%s, ninumber=%s, netpay=%s WHERE ref=%s", (
            ...
            sqlCon.close()
            tkinter.messagebox.showinfo(
                "Data Entry Form", "Record Successfully Updated")
 # ==============================================================================================           
        def deleteDB():
            sqlCon = pymysql. connect(
                host="localhost", user="root", password="chidang251103", database="payment")
            cur = sqlCon.cursor()
            cur.execute("DELETE from payment WHERE ref=%s", EmployeeName.get())
            
            sqlCon.commit()
            DisplayData()
            sqlCon.close()
            tkinter.messagebox.showinfo(
                "Data Entry Form", "Record Successfully Deleted")
            Reset()
...
# ==============================================================================================
        ...
        Tab3Frame = Frame(self.Tabcontrol3, bd=10,
                          width=1350, height=700, relief=RIDGE)
        Tab3Frame.grid()

        TopFrame1 = Frame(MainFrame, bd=10, width=1340,
                          height=100, relief=RIDGE)
        TopFrame1.grid()
        TopFrame2 = Frame(MainFrame, bd=10, width=1340,
                          height=100, relief=RIDGE)
        TopFrame2.grid()
        ...
        LeftFrame1 = Frame(LeftFrame, bd=5, width=600,
                           height=180, padx=2, relief=RIDGE)
        LeftFrame1.pack(side=TOP)

        LeftFrame2 = Frame(LeftFrame, bd=5, width=600,
                           height=180, padx=2, bg="cadetblue", relief=RIDGE)
        LeftFrame2.pack(side=TOP)
        LeftFrame2Left = Frame(LeftFrame2, bd=5, width=300,
                               height=170, padx=2, relief=RIDGE)
        LeftFrame2Left.pack(side=LEFT)
        LeftFrame2Right = Frame(
            LeftFrame2, bd=5, width=300, height=170, padx=2, relief=RIDGE)
        LeftFrame2Right.pack(side=RIGHT)

        LeftFrame3Left = Frame(LeftFrame, bd=5, width=320,
                               height=50, padx=2, bg="cadetblue", relief=RIDGE)
        LeftFrame3Left.pack(side=LEFT)
        LeftFrame3Right = Frame(
            LeftFrame, bd=5, width=320, height=50, padx=2, bg="cadetblue", relief=RIDGE)
        LeftFrame3Right.pack(side=RIGHT)

        RightFrame1 = Frame(TopFrame3, bd=5, width=320,
                            height=400, padx=2, bg="cadetblue", relief=RIDGE)
        RightFrame1.pack(side=RIGHT)
        RightFrame1a = Frame(RightFrame1, bd=5, width=310,
                             height=300, padx=2, relief=RIDGE)
        RightFrame1a.pack(side=TOP)
        RightFrame1b = Frame(RightFrame1, bd=5, width=310,
                             height=100, padx=2, relief=RIDGE)
        RightFrame1b.pack(side=TOP)

        RightFrame2 = Frame(TopFrame3, bd=5, width=300,
                            height=400, padx=2, bg="cadetblue", relief=RIDGE)
        RightFrame2.pack(side=LEFT)
        RightFrame2a = Frame(RightFrame2, bd=5, width=280,
                             height=50, padx=2, relief=RIDGE)
        RightFrame2a.pack(side=TOP)
        RightFrame2b = Frame(RightFrame2, bd=5, width=280,
                             height=180, padx=2, relief=RIDGE)
        RightFrame2b.pack(side=TOP)
        RightFrame2c = Frame(RightFrame2, bd=5, width=280,
                             height=100, padx=2, relief=RIDGE)
        RightFrame2c.pack(side=TOP)
        RightFrame2d = Frame(RightFrame2, bd=5, width=280,
                             height=50, padx=2, bg="cadetblue", relief=RIDGE)
        RightFrame2d.pack(side=TOP)
# ==============================================================================================
        self.lblTitle = Label(TopFrame1, font=(
            'arial', 40, 'bold'), text="\tPayroll Management System\t", justify=CENTER)
        self.lblTitle.grid(padx=76)
# ==============================================================================================
        self.lblEmployeeName = Label(TopFrame2, font=(
            'arial', 12, 'bold'), text="EmployeeName", justify=CENTER)
        ...
        self.lblAddress = Label(TopFrame2, font=(
            'arial', 12, 'bold'), text="Address", bd=10)
        ...
        self.lblPostCode = Label(TopFrame2, font=(
            'arial', 12, 'bold'), text="Post Code ", bd=5)
        ...
        self.lblGender = Label(TopFrame2, font=(
            'arial', 12, 'bold'), text="Gender", bd=10)
        self.lblGender.grid(row=1, column=2, sticky=W)
        self. cboGender = ttk.Combobox(TopFrame2, textvariable=Gender, state='readonly',
                                       font=('arial', 14, 'bold'), width=46)
        self.cboGender['value'] = ('', 'Female', 'Male')
        self.cboGender.current(0)
        self.cboGender.grid(row=1, column=3)
# ==============================================================================================
        self.lblPayday = Label(RightFrame2a, font=(
            'arial', 12, 'bold'), text="Payday", bd=10)
        ...
        self.lblTaxPeriod = Label(RightFrame2b, font=(
            'arial', 12, 'bold'), text="Tax Period", bd=10)
        ...
        self.lblTaxCode = Label(RightFrame2b, font=(
            'arial', 12, 'bold'), text="Tax Code", bd=10)
        ...
        self.lblNINumber = Label(RightFrame2b, font=(
            'arial', 12, 'bold'), text="NI Number", bd=10)
        ...
        self.lbINICode = Label(RightFrame2b, font=(
            'arial', 12, 'bold'), text="NI Code", bd=10)
        self.lbINICode.grid(row=3, column=0, sticky=W)
        ...
        self.lblTaxablePay = Label(RightFrame2c, font=(
            'arial', 12, 'bold'), text="Taxable Pay", bd=10)
        ...
        self.lblPensionablePay = Label(RightFrame2c, font=(
            'arial', 12, 'bold'), text="Pensionable Pay", bd=10)
        ...
        self.lblNetPay = Label(RightFrame2d, font=(
            'arial', 12, 'bold'), text="Net Pay", bd=10)
...
# ==============================================================================================
        self.lblReference = Label(LeftFrame1, font=(
            'arial', 12, 'bold'), text="Reference", bd=10)
        ...
        self.lblEmployerName = Label(LeftFrame1, font=(
            'arial', 12, 'bold'), text="Employer Name", bd=10)
        ...
        self.lblEmployeeName = Label(LeftFrame1, font=(
            'arial', 12, 'bold'), text="Employee Name", bd=10)
...
# ==============================================================================================
        ...
        self.lblCityWeighting = Label(LeftFrame2Left, font=(
            'arial', 12, 'bold'), text="City Weighting", bd=10)
        ...
        self.lblBasicSalary = Label(LeftFrame2Left, font=(
            'arial', 12, 'bold'), text="Basic Salary", bd=10)
        ...
        self.lblOverTime = Label(LeftFrame2Left, font=(
            'arial', 12, 'bold'), text="Over Time", bd=10)
        ...
        self.lblOtherPaymentDue = Label(LeftFrame2Left, font=(
            'arial', 12, 'bold'), text="Other Payment", bd=10)
...
# ======================================================
        self.lblTax = Label(LeftFrame2Right, font=(
            'arial', 12, 'bold'), text="Tax", bd=10)
        ...
        self.lblPension = Label(LeftFrame2Right, font=(
            'arial', 12, 'bold'), text="Pension", bd=10)
        ...
        self.lblStudentLoan = Label(LeftFrame2Right, font=(
            'arial', 12, 'bold'), text="Student Loan", bd=10)
        ...
        self.lblNIPayment = Label(LeftFrame2Right, font=(
            'arial', 12, 'bold'), text="NI Payment", bd=10)
        ...
        self.lblGrossPay = Label(LeftFrame3Left, font=(
            'arial', 12, 'bold'), text="Gross Pay", bd=10)
        ...
        self.lblDeductions = Label(LeftFrame3Right, font=(
            'arial', 12, 'bold'), text="Deductions", bd=10)
...
# ==========================================-===================================================
        self.btnDigit4 = Button(RightFrame1a, padx=6, pady=7, bd=2, font=('arial', 16, 'bold'), width=4,
                                text="4", command=lambda: btnClick(4)).grid(row=2, column=0)
        self.btnDigit5 = Button(RightFrame1a, padx=6, pady=7, bd=2, font=('arial', 16, 'bold'), width=4,
                                text="5", command=lambda: btnClick(5)).grid(row=2, column=1)
        self.btnDigit6 = Button(RightFrame1a, padx=6, pady=7, bd=2, font=('arial', 16, 'bold'), width=4,
                                text="6", command=lambda: btnClick(6)).grid(row=2, column=2)
        self.btnSub = Button(RightFrame1a, padx=6, pady=7, bd=2, font=('arial', 16, 'bold'), width=4,
                             text="-", command=lambda: btnClick("-")).grid(row=2, column=3)
# ==========================================-===================================================
        self.btnDigit1 = Button(RightFrame1a, padx=6, pady=7, bd=2, font=('arial', 16, 'bold'), width=4,
                                text="1", command=lambda: btnClick(1)).grid(row=3, column=0)
        self.btnDigit2 = Button(RightFrame1a, padx=6, pady=7, bd=2, font=('arial', 16, 'bold'), width=4,
                                text="2", command=lambda: btnClick(2)).grid(row=3, column=1)
        self.btnDigit3 = Button(RightFrame1a, padx=6, pady=7, bd=2, font=('arial', 16, 'bold'), width=4,
                                text="3", command=lambda: btnClick(3)).grid(row=3, column=2)
        self.btnMulti = Button(RightFrame1a, padx=6, pady=7, bd=2, font=('arial', 16, 'bold'), width=4,
                               text="*", command=lambda: btnClick("*")).grid(row=3, column=3)
# ==========================================-===================================================
        self.btnDigitO = Button(RightFrame1a, padx=6, pady=7, bd=2, fg="black", font=('arial', 16, 'bold'), width=4,
                                text="0", command=lambda: btnClick(0)) .grid(row=4, column=0)
        self.btnClear = Button(RightFrame1a, padx=6, pady=7, bd=2, fg="black", font=('arial', 16, 'bold'), width=4,
                               text="C", command=btnClear) .grid(row=4, column=1)
        self.btnEquals = Button(RightFrame1a, padx=6, pady=7, bd=2, fg="black", font=('arial', 16, 'bold'), width=4,
                                text="=", command=btnEquals) .grid(row=4, column=2)
        self.btnDiv = Button(RightFrame1a, padx=6, pady=7, bd=2, fg="black", font=('arial', 16, 'bold'), width=4,
                             text="/", command=lambda: btnClick("/")) .grid(row=4, column=3)
# ==========================================-===================================================
        self.btnWages = Button(RightFrame1b, padx=16, pady=0, bd=5, font=('arial', 16, 'bold'), width=4,
        ...
        self.btnUpdate = Button(RightFrame1b, padx=16, pady=0, bd=5, font=('arial', 16, 'bold'), width=4,
                                text="Update", command=update).grid(row=0, column=2)
        self.btnDelete = Button(RightFrame1b, padx=16, pady=0, bd=5, font=('arial', 16, 'bold'), width=4,
                                text="Delete", command=deleteDB) .grid(row=1, column=0)
        self.btnReset = Button(RightFrame1b, padx=16, pady=0, bd=5, font=('arial', 16, 'bold'), width=4,
                               text="Reset", command=Reset) .grid(row=1, column=1)
        self.btnExit = Button(RightFrame1b, padx=16, pady=0, bd=5, font=('arial', 16, 'bold'), width=4,
                              text="Exit", command=iExit).grid(row=1, column=2)
# ==============================================================================================
        TopFrame11 = Frame(Tab2Frame, bd=10, width=1340,
                           height=100, relief=RIDGE)
        TopFrame11.grid(row=0, column=0)
        TopFrame12 = Frame(Tab2Frame, bd=10, width=1340,
                           height=100, relief=RIDGE)
        TopFrame12.grid(row=1, column=0)
# ==============================================================================================
        self.lblTitle = Label(TopFrame11, font=(
            'arial', 40, 'bold'), text=" \tPayroll Management System\t", bd=10, justify=CENTER)
        self.lblTitle.grid(padx=72)
# ==============================================================================================
        scroll_x = Scrollbar(TopFrame12, orient=HORIZONTAL)
        scroll_y = Scrollbar(TopFrame12, orient=VERTICAL)

        self.payroll_records = ttk.Treeview(TopFrame12, height=22, columns=("ref", "fullname", "address", "cityweighting", "basicsalary", "overtime",
                                                                           "grosspay", "tax", "pension", "nipayment", "deductions", "postcode", "gender", "payday", "taxperiod", "taxcode", "ninumber", "netpay"), xscrollcommand=scroll_x.set, yscrollcommand=scroll_y.set)
...
# ==============================================================================================
        TopFrame13 = Frame(Tab3Frame, bd=10, width=1340,
                           height=100, relief=RIDGE)
        TopFrame13.grid(row=0, column=0)
# ==============================================================================================
        self.lblNote = Label(TopFrame13, font=(
            'arial', 40, 'bold'), text="\tPayroll NoteBook\t", bd=10, justify=CENTER)
        self.lblNote.grid(row=0, column=0)
        
# ==============================================================================================
        self.txtNote = Text(TopFrame13, width=120,
                            height=22, font=('arial', 14, 'bold'))
